...
module.exports = {
    ...
    getPastAppointments: (req,res) => {
        sequelize.query(`SELECT a.appt_id, a.service_type, a.notes, u.first_name, u.last_name
        FROM cc_appointments AS a
        JOIN cc_emp_appts AS ea ON a.appt_id = ea.appt_id
        JOIN cc_empoloyees AS e ON ea.emp_id = e.emp_id
